...
public class Morador {
    ...
    public Morador(Long id, Long idApartamento, String nome, String rg, String cpf, String telefone1, String telefone2, String email,
            String contatoEmergencia, String ceTelefone, String observacao) {
        this.id = id;
    ...
    public Morador (MoradorForm form) {
        ...
        this.ceTelefone = form.getCeTelefone ();
